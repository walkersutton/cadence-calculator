...
def generate_cadence_data(distances, chainring, cog, wheel_diameter, tire_width): # might want tire_width, diameter, etc.
	...
	for distance_travelled in distances:
		#  use bike Class?
		cadences.append(generate_cadence(distance_travelled - last_distance_travelled, chainring, cog, wheel_diameter, tire_width))
